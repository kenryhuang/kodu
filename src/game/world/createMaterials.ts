...
export function createMaterials(scene: Scene) {
  ...
  const terrainRoad = makeImageTextured("mat-terrain-road", "/assets/textures/concept/dirt-road.png", new Color3(0.72, 0.48, 0.26), 1.6, 2.8, true, 0.045);
  terrainRoad.diffuseColor = new Color3(1.16, 0.9, 0.62);
  terrainRoad.emissiveColor = new Color3(0.08, 0.05, 0.025);
